                    ...
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-20 px-5 md:px-10">
                            ...
                            <div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input type="email" onChange={(e) => { setUser({ ...user, email: e.target.value }) }} className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="smith@exa.com" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button onClick={loginUser} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Sign In</button>
                                    </div>
                                </div>
                                <div className='text-right py-2'>Don't have an account? <Link to="/signup"><span className="text-blue-500 underline">Sign Up</span></Link></div>
                            </div>
                        </div>
                    </div>
                </div>
